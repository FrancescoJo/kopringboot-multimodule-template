 ...
 * some emojis which are represented as a single glyph but consisted of multiple unicode characters are not validated
 ...
 *
 * This validation is working in time complexity of O(N). Therefore, you should consider carefully using this
